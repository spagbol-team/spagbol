  ...
  return (
    <div className="flex items-center">
      <div className="relative w-96">
        ...
        ></input>
        <button
          className="bg-gray-700 text-white absolute right-1.5 bottom-1.5 focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-1"
          onClick={clearInput}
        >
